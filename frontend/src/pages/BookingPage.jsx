...
function BookingPage() {
  ...
  /* =========================================================
     LOAD EVENT + CONFIRMED BOOKED SEATS
     ========================================================= */
  ...
  useEffect(() => {
    const loadBookingData = async () => {
      try {
        ...
        // -----------------------------------------------------
        // LOAD ONLY CONFIRMED BOOKINGS FOR THIS EVENT
        // -----------------------------------------------------

        const bookingsResponse =
          await getEventBookings(id);

        console.log(
          "EVENT BOOKINGS RESPONSE:",
          bookingsResponse
        );
        ...
        //
        // Cancelled bookings are NOT returned by backend.
        // -----------------------------------------------------
        ...
        // -----------------------------------------------------
        // COLLECT CONFIRMED BOOKED SEATS
        // -----------------------------------------------------
        ...
        const uniqueConfirmedSeats = [
          ...new Set(confirmedSeats),
        ];

        console.log(
          "CONFIRMED BOOKED SEATS:",
          uniqueConfirmedSeats
        );
          ...
          <div className="col-lg-8">
            ...
            <div className="booking-card mb-4">
              <div className="booking-card-header">
                ...
                <p className="text-muted small mb-0">
                  Check the event information before
